...
const { buildResourceSearchHttpLink, buildResourceSearchLink } = require('@/utils/telegram');
        ...
        const newItems = response.data.subject_collection_items
            ...
            .map((item) => {
                ...
                const description = art(path.join(__dirname, '../templates/list_description.art'), {
                    ...
                    telegram_search_http_link: buildResourceSearchHttpLink(title),
                    telegram_search_link: buildResourceSearchLink(title),
                    details,
